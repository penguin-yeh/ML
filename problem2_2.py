class MyCNN(nn.Module): #MyCNN繼承了nn.Module
  ...
  def __init__(self, num_classes=1000):
    ...
    self.features = nn.Sequential( #an ordered container
      ...
      nn.Conv2d(3, 64, kernel_size=11, stride=4, padding=2), #((224+2*2-11)/4)+1=55  # output_shape=(64,55,55)
    ...
    self.features2 = nn.Sequential(
      ...
      nn.Conv2d(256, 256, kernel_size=3, padding=1), #output_shape = (256,6,6)
      nn.ReLU(inplace=True),
      #nn.MaxPool2d(kernel_size=3, stride=2), #output_shape = (256,2,2)
